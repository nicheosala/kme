...
class QCServer:
    ...
    def start(self) -> None:
        ...
        logging.getLogger("sd_qkd_node").info(f"QCServer listening on {self.host}:{self.port}")
    ...
    def stop(self) -> None:
        ...
        logging.getLogger("sd_qkd_node").info(f"QCServer shutdown completed.")
...
class ThreadedTCPRequestHandler(StreamRequestHandler):
    ...
    def handle(self) -> None:
        ...
        logging.getLogger("sd_qkd_node").debug(f"Received new block with id {new_block.id}")
