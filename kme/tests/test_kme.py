...
def test_get_key_with_invalid_number(client: Client) -> None:
...
def test_get_key_with_key_i_ds(client: Client) -> None:
...
def test_get_key_with_key_i_ds_with_invalid_key_id(client: Client) -> None:
    """
...
def test_get_status(client: Client) -> None:
...
def test_post_key(client: Client) -> None:
...
def test_post_key_with_invalid_key_size(client: Client) -> None:
    """
...
def test_post_key_with_key_i_ds(client: Client) -> None:
...
def test_post_key_non_empty_extension_mandatory(client: Client) \
        -> None:
